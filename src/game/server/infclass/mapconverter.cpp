...
//	Quad.m_aTexcoords[1] = { f2fx(1.0), 0 };
//	Quad.m_aTexcoords[2] = { 0, f2fx(1.0) };
//	Quad.m_aTexcoords[3] = { f2fx(1.0), f2fx(1.0) };
	
//	Quad.m_aTexcoords[1].x = f2fx(1.0);
//	Quad.m_aTexcoords[2].x = f2fx(1.0);
//	Quad.m_aTexcoords[3].x = f2fx(1.0);
	
//	Quad.m_aTexcoords[1].y = 0;
//	Quad.m_aTexcoords[2].y = f2fx(1.0);
//	Quad.m_aTexcoords[3].y = f2fx(1.0);
...
//		aQuads.add(Quad);
		...
		InitQuad(&Quad, Pos/*+vec2(0.0f, -4.0f)*/, vec2(Size, Size));
		Quad.m_ColorEnv = Env;
		Quad.m_aTexcoords[0].x = Quad.m_aTexcoords[2].x = f2fx(0.5);
		Quad.m_aTexcoords[1].x = Quad.m_aTexcoords[3].x = f2fx(1.0);
		Quad.m_aTexcoords[0].y = Quad.m_aTexcoords[1].y = f2fx(0.5);
		Quad.m_aTexcoords[2].y = Quad.m_aTexcoords[3].y = f2fx(1.0);
...
{
	m_TimeShiftUnit = 0;
	int EngineerImageID = AddExternalImage("../skins/body/kitty", 256, 256);
//	int EngineerImageID = AddExternalImage("kitty", 256, 256);
//	int EngineerImageID = AddExternalImage("sun", 512, 512);
	int SoldierImageID = EngineerImageID;
	int ScientistImageID = EngineerImageID;
	int BiologistImageID = EngineerImageID;
	int LooperImageID = EngineerImageID;
	int MedicImageID = EngineerImageID;
	int HeroImageID = EngineerImageID;
	int NinjaImageID = EngineerImageID;
	int MercenaryImageID = EngineerImageID;
	int SniperImageID = EngineerImageID;
//	int SoldierImageID = AddExternalImage("../skins/body/bear", 256, 256);
//	int MedicImageID = AddExternalImage("../skins/body/mouse", 256, 256);
...
//	int SniperImageID = AddExternalImage("../skins/warpaint", 256, 128);
	...
	const float MenuAngleStart = 0;// -pi/2.0f;
	
	{
		const float MenuAngleStep = 360.0 /static_cast<float>(NUM_MENUCLASS);
